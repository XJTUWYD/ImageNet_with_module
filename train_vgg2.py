...
def train(
	...
	"""
	train_img_path = os.path.join(imagenet_path, '/data0/ILSVRC2012/ILSVRC2012_img_train')
	...
	pred, _ = vgg.classifier(x_b, keep_prob)
...
if __name__ == '__main__':
	...
	IMAGENET_PATH = '/data0/ILSVRC2012'
	DISPLAY_STEP = 10
	TEST_STEP = 500
	...
	train(
		...
		MOMENTUM,
		LAMBDA, 
		False,		#True means use existed model,False means start from the very begining
		IMAGENET_PATH, 
		DISPLAY_STEP, 
		TEST_STEP, 
		CKPT_PATH, 
